package com.example.doBeckAoFront.controller;

import com.example.doBeckAoFront.model.Usuario;
import com.example.doBeckAoFront.service.UsuarioService;
...
@CrossOrigin(origins = "*")// aceita coexão de aplicaçoes externas
@RestController
...
public class UsuarioController {
    ...
    public List<Usuario> listartodos(){
        return usuarioService.lisstarUsuarios();
    }
